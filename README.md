...
Read the `ycsb/README.md` to know more about sending YCSB Workload.

# Send SMALLBANK Workload
## Quick Start
...
Read the `smallbank/README.md` to know more about sending SMALLBANK Workload.
