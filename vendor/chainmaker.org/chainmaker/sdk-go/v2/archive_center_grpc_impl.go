...
func (a *ArchiveCenterGrpcClient) GetTxByTxId(txId string) (*common.TransactionInfo, error) {
	...
	detailResp, err := a.client.GetTxDetailByTxId(ctx,
		&archivePb.TxDetailByIdRequest{
			ChainUnique: a.config.ChainGenesisHash,
			TxId:        txId,
		}, a.GrpcCallOption()...)
	if err != nil {
	...
	return &common.TransactionInfo{
		...
		BlockHeight:    detailResp.Height,
		BlockHash:      nil,
		TxIndex:        0, //TODO
		BlockTimestamp: int64(detailResp.TxConfirmedTime),
	}, nil
}
